<?php
exit("Wrong file to Run. Use data_expiredaccts\n");
...
//OLD CONTRACT ACCOUNT JOINS - NOT CONSISTENT
/*
$query_expires = "
SELECT
accounts.name,
...
echo date('Y-m-d H:i:s')." Getting expired accounts ... \n";
...
For enquiries Call:0700777776';
					...
					if($texts[message_status] == 'Ready'){
						...
						$sms_log[$row[name].' ['.$texts[msisdn].']'] = $sms_results[$send_result['result']];
						echo date('Y-m-d H:i:s')." Account [".$accnt_id."] : Sending SMS to [".$texts[msisdn]."] : Result : [".$send_result[result]."] \n";
...
//$log[bcc] = 'Steven Ntambi/Customer Service/Uganda <steven.ntambi@ug.airtel.com>, Geoffrey Kasibante/Customer Care/Airtel Ug <Geoffrey.Kasibante@ug.airtel.com>, Emmanuel Agwa/IBM/Uganda <emmlagwa@ug.ibm.com>, Jamil Kireri/IT/Uganda <jamil.kireri@ug.airtel.com>';
$log[from] = 'Expiry Notification Mailer <ccnotify@waridtel.co.ug>';
...
$to ="Yvonne Wekesa/Enterprise Business/Kampala <Yvonne.Wekesa@ug.airtel.com>,Kenneth Muzahura/Customer Service/Uganda <Kenneth.Muzahura@ug.airtel.com>,Isaac Kiyingi/Customer Service/Uganda <Isaac.Kiyingi@ug.airtel.com>, Jennifer Nakaddu/Customer Service/Uganda <Jennifer.Nakaddu@ug.airtel.com>,Phiona N. Ireemera <Phiona.Ireemera@ug.airtel.com>, Catherine A. Alungur <Catherine.Alungur@ug.airtel.com>, Phiona N. Ireemera <Phiona.Ireemera@ug.airtel.com>, Gaudy Baine/Service Experience/Uganda <gaudy.baine@ug.airtel.com>, Rita Tamale/Credit Control/Uganda <Rita.Tamale@ug.Airtel.com>";
$to ="Steven GMAIL <steven.ntambi@gmail.com>,Steven Ntambi/Customer Service/Uganda <steven.ntambi@ug.airtel.com>";
//$bcc = 'Steven Ntambi/Customer Service/Uganda <steven.ntambi@ug.airtel.com>, Geoffrey Kasibante/Customer Care/Airtel Ug <Geoffrey.Kasibante@ug.airtel.com>, Emmanuel Agwa/IBM/Uganda <emmlagwa@ug.ibm.com>, Jamil Kireri/IT/Uganda <jamil.kireri@ug.airtel.com>';
$subject = "Broadband Expiry Notifications ".date('Y-m-d');
sendHTMLemail($to,$bcc,$HTML,$subject,'');
