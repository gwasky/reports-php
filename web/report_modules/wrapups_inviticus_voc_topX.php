<?php
function generate_wrapups_topx_report($upto,$reporttype,$top=5,$subject_type_filter){
	switch($reporttype){
		case 'weekly':
			$report_display = generate_inviticus_voc_topX_wrapups_week($upto = false,$top=10,$subject_type_filter);
			break;
		case 'daily':
			$report_display = generate_inviticus_voc_topX_wrapups($upto,$top=5,$subject_type_filter);
			break;
		case 'both':
			$report_display = generate_inviticus_voc_topX_wrapups_week($upto = false,$top=10,$subject_type_filter);
			$report_display .= generate_inviticus_voc_topX_wrapups($upto,$top=5,$subject_type_filter);
