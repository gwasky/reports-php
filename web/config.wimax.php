...
$configuration['db']	= 'wimax'; 							//	database name
$configuration['host']	= '172.27.98.31';		//	database host
$configuration['user']	= 'sugarcrm';						//	database user
$configuration['pass']	= '1sugarpass2';					//	database password
